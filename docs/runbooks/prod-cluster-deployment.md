...
- IPs are correct (10.10.10.10, .20, .21)
...
- Try manually: `talosctl --talosconfig ../talosconfig bootstrap --nodes 10.10.10.10`
...
```bash
ping 10.10.10.10     # Control plane
ping 10.10.10.20     # Worker 1
ping 10.10.10.21     # Worker 2
nc -zv 10.10.10.10 50000   # Talos API
nc -zv 10.10.10.10 6443    # Kubernetes API
```
...
talosctl --nodes 10.10.10.10 get members
talosctl --nodes 10.10.10.10 services
```
...
**Problem:** After VMs booted on PROD VLAN (10.10.10.0/16), the Mac on the management network (192.168.1.0/24) could not reach them. `ping 10.10.10.10` timed out, `nc -zv 10.10.10.10 6443` returned "Can't assign requested address".
...
```bash
talosctl --nodes 10.10.10.10 image pull gcr.io/etcd-development/etcd:v3.6.5
```
...
```bash
talosctl --nodes 10.10.10.10 bootstrap
```
...
| Component | Status |
|-----------|--------|
| prod-cp-01 (10.10.10.10) | Running, control-plane |
| prod-wk-01 (10.10.10.20) | Running, worker |
| prod-wk-02 (10.10.10.21) | Running, worker |
| Kubernetes API | Accessible at https://10.10.10.10:6443 |
...
talosctl --nodes 10.10.10.10 services
talosctl --nodes 10.10.10.10 get members
talosctl --nodes 10.10.10.10 dmesg
talosctl --nodes 10.10.10.10 logs kubelet
talosctl --nodes 10.10.10.10 logs etcd
